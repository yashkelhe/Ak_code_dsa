...
public class Nqueen {
    ...
    public static void nQueen(char board[][], int row) {
        ...
        // here we use the loop becouse we want to iterate over the colums also for that
        // we use the for loop
        // and the is=nside that we have again call the nQueen function that will
        // incrment the row
    ...
    public static Boolean isSafe(char board[][], int row, int col) {
        ...
        // If any cell (i, col) contains a queen ('Q'), it returns false, indicating the
        ...
        // diagonal left
        // This loop checks all cells in the upper left diagonal from the current
        // position.
        // If any cell (i, j) contains a queen ('Q'), it returns false, indicating the
        // position is not safe.
